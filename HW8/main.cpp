...
// Date: 04-15-21
// Description: Chapter 8 Solution
...
int menuOption()
{
	...
	cout << "\t" << char(186) << "   1: Simulation of War                       " << char(186) << "\n";
	cout << "\t" << char(186) << "   2: Simulation of an emergency room         " << char(186) << "\n";
	cout << "\t" << char(186) << "   3: Simulation of checkout lines at CostCo  " << char(186) << "\n";
